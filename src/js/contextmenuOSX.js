...
var Contextmenu = {
    init: function() {
        ...
        var separatorFactory = this.factory.separatorFactory;
        var clearHistoryMenuFactory = this.factory.clearHistoryMenuFactory;
        var toolbarMenuFactory = this.factory.toolbarMenuFactory;
        var consoleMenuFactory = this.factory.consoleMenuFactory;
        ...
        var viewRunMenuItem = new gui.MenuItem({
            label: '运行 (F5)',
            enabled: false,
            click: function() {
        ...
        viewMenu.append(viewRunMenuItem);
        source['view-run'] = viewRunMenuItem;
    ...
    showToolOrConsole: function(that, type) {
        var markdown = global.markdown;
        var cache = markdown.cache;
    ...
    factory: {
        ...
        separatorFactory: function() {
            return Contextmenu.factory.create({
                type: 'separator'
            });
        },

        clearHistoryMenuFactory: function() {
            var markdown = global.markdown;
        ...
        toolbarMenuFactory: function() {
            var self = Contextmenu.factory;
            ...
            return self.create({
                ...
                checked: true,
                click: function() {
                    self.showToolOrConsole(this, 'toolbar');
                }
            });
        },

        consoleMenuFactory: function() {
            var self = Contextmenu.factory;
            ...
            return self.create({
                ...
                checked: true,
                click: function() {
                    self.showToolOrConsole(this, 'console');
                }
            });
        },
...
exports.init = Contextmenu.init;
exports.contextMenuSource = Contextmenu.contextMenuSource;
exports.factory = Contextmenu.factory;